...
def init():
    ...
    defaults = {'Write': {'skill': 'Write', 'constraints': {'deny_content': ['staging.internal', '*.internal', '*.staging.*', 'localhost', '127.0.0.1', 'BEGIN RSA PRIVATE KEY', 'BEGIN PRIVATE KEY', 'sk-', 'ghp_', 'xoxb-', 'AKIA']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'Edit': {'skill': 'Edit', 'constraints': {'deny_content': ['staging.internal', '*.internal', '*.staging.*', 'localhost', '127.0.0.1', 'BEGIN RSA PRIVATE KEY', 'BEGIN PRIVATE KEY', 'sk-', 'ghp_', 'xoxb-', 'AKIA']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'Bash': {'skill': 'Bash', 'constraints': {'deny_content': ['rm -rf /', 'rm -rf ~', 'dd if=/dev/zero', 'mkfs', '| bash', '| sh', 'github:*/', 'npm install git+', 'pip install git+http', 'eval $(', 'exec 3<>/dev/tcp']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'str_replace_based_edit_tool': {'skill': 'str_replace_based_edit_tool', 'constraints': {'deny_content': ['staging.internal', '*.internal', 'BEGIN RSA PRIVATE KEY', 'BEGIN PRIVATE KEY', 'sk-', 'ghp_', 'AKIA']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'MultiEdit': {'skill': 'MultiEdit', 'constraints': {'deny_content': ['staging.internal', '*.internal', 'BEGIN PRIVATE KEY', 'sk-', 'ghp_']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'search': {'skill': 'search', 'constraints': {'deny_content': ['staging.internal', 'DROP TABLE', 'rm -rf']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'execute_code': {'skill': 'execute_code', 'constraints': {'deny_content': ['os.system(', 'eval(', 'exec(', 'rm -rf', 'DROP TABLE']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'write_file': {'skill': 'write_file', 'constraints': {'deny_content': ['staging.internal', '*.internal', 'BEGIN PRIVATE KEY', 'sk-', 'ghp_']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'read_file': {'skill': 'read_file', 'constraints': {'deny_content': ['/etc/passwd', '/etc/shadow', '/.ssh/id_rsa']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'web_request': {'skill': 'web_request', 'constraints': {'deny_content': ['staging.internal', '*.internal', 'localhost', '127.0.0.1']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'http_request': {'skill': 'http_request', 'constraints': {'deny_content': ['staging.internal', '*.internal', 'localhost', '127.0.0.1']}, 'version': '1.0.0', '_source': 'k9log init defaults'}, 'send_email': {'skill': 'send_email', 'constraints': {'deny_content': ['@attacker', 'phish', 'malware']}, 'version': '1.0.0', '_source': 'k9log init defaults'}}
    installed, skipped = [], []
